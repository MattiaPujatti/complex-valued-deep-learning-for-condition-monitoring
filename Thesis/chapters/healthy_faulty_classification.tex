...
% explain two axis, one healthy and one faulty 
...
In table \ref{tab:bonfigloli_ds_results} we summarized the accuracy and loss obtained for all the single datasets provided by Bonfiglioli, via binary classification for 100 epochs.
\begin{table}[!ht]
	\centering
	\begin{tabular}{c | c c c c c}
		\toprule
		...
		\midrule
		4\_2           & 3508 & Unbalance & 100 - 100 & 0.52 - 0.14 \\
		5\_3           & 100  & Bearing   &  \\
		5\_3 w/ multi  & 6071 & Bearing   & 99.74 - 99.80 & 7.398 - 5.014 \\
		6\_3\_1        & 700  & Bearing   & 96.17 - 100 & 106.924 - 0.18 \\
		6\_3\_2        & 2102 & Bearing   & 100 - 100 & 0.008 - 0.004 \\
		10\_1          & 100 & Solar     &   \\
		10\_1 w/ multi & 5966 & Solar     & 99.41 - 99.48 & 7.638 - 6.710 \\
		10\_4 		   & 100 & Solar     &  \\
		10\_4 w/ multi & 5979 & Solar     & 99.04 - 100 & 11.538 - 5.142  \\
		11\_1      	   & 100 & Bearing   &  \\
		11\_1 w/ multi & 3744 & Bearing   & 100 - 100 & 0.028 - 0.001 \\
		13\_1          & 100 & Pinion    &  \\
		13\_1 w/ multi & 3750 & Pinion    & 100 - 100 & 0.007 - 0.001 \\
		15\_1          & 100 & Crown     &  \\
		15\_1 w/ multi & 1498 & Crown     & 100 - 100 & 2.025 - 0.039 \\
		15\_2          & 100 & Crown     &   \\
		15\_2 w/ multi & 100 & Crown     &  \\
		\bottomrule
	\end{tabular}
	\caption{Binary classification of single Bonfiglioli datasets.}
	\label{tab:bonfigloli_ds_results}
\end{table}


% MAYBE IS FAULT OF POOR CORRELATION
% WHEN MULTICLASS REMEMBER TO CREATE PROPORTIONAL SETS
...
\begin{table}[!ht]
	...
	\begin{tabular}{c | c c c c}
		...
		\bottomrule	
	\end{tabular}
	\caption{Statistical estimators of the Bonfiglioli analysis.}
\end{table}
\begin{figure}[!ht]
	\centering
...
% help reducing parameters because you remove all fully connected

In the section above we were struggling because we couldn't 
